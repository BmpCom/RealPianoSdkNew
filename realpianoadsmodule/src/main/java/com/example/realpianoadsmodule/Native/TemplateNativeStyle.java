...
public class TemplateNativeStyle {
    private float callToActionTextSize, secondaryTextSize, tertiaryTextSize, primaryTextSize;
    private ColorDrawable mainBackgroundColor, callToActionBackgroundColor, tertiaryTextBackgroundColor, secondaryTextBackgroundColor, primaryTextBackgroundColor;
    private Typeface secondaryTextTypeface, callToActionTextTypeface, tertiaryTextTypeface, primaryTextTypeface;
    private int secondaryTextTypefaceColor, callToActionTypefaceColor, primaryTextTypefaceColor, tertiaryTextTypefaceColor;
    ...
    public static class Builder {
        private final TemplateNativeStyle styles = new TemplateNativeStyle();
        ...
        public TemplateNativeStyle build() {
            return this.styles;
        }
    }
}
